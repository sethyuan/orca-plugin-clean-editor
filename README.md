...
An Orca Note plugin that hides query controls to make the interface cleaner.

## Usage

1. Download the zip file from the [releases page](https://github.com/sethyuan/orcanote-clean-editor/releases) and extract it into Orca Note's `plugins` directory.
2. Start/restart Orca Note, enable the plugin under the app's settings.
3. Create and tweak your table block then select a formatting in the table block's menu (under the plugin commands section).
